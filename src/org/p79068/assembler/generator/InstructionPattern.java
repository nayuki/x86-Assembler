...
public final class InstructionPattern {
	...
	static {
		...
		mode32.add(new InstructionPattern("addwb" , new OperandPattern[]{RM16, IMM8}          , MODE16  , new int[]{0x83}, new ModRM(0, 10)));
		mode32.add(new InstructionPattern("orwb"  , new OperandPattern[]{RM16, IMM8}          , MODE16  , new int[]{0x83}, new ModRM(0, 11)));
		mode32.add(new InstructionPattern("adcwb" , new OperandPattern[]{RM16, IMM8}          , MODE16  , new int[]{0x83}, new ModRM(0, 12)));
		mode32.add(new InstructionPattern("sbbwb" , new OperandPattern[]{RM16, IMM8}          , MODE16  , new int[]{0x83}, new ModRM(0, 13)));
		mode32.add(new InstructionPattern("andwb" , new OperandPattern[]{RM16, IMM8}          , MODE16  , new int[]{0x83}, new ModRM(0, 14)));
		mode32.add(new InstructionPattern("subwb" , new OperandPattern[]{RM16, IMM8}          , MODE16  , new int[]{0x83}, new ModRM(0, 15)));
		mode32.add(new InstructionPattern("xorwb" , new OperandPattern[]{RM16, IMM8}          , MODE16  , new int[]{0x83}, new ModRM(0, 16)));
		mode32.add(new InstructionPattern("cmpwb" , new OperandPattern[]{RM16, IMM8}          , MODE16  , new int[]{0x83}, new ModRM(0, 17)));
		mode32.add(new InstructionPattern("addlb" , new OperandPattern[]{RM32, IMM8}          , MODE32  , new int[]{0x83}, new ModRM(0, 10)));
		mode32.add(new InstructionPattern("orlb"  , new OperandPattern[]{RM32, IMM8}          , MODE32  , new int[]{0x83}, new ModRM(0, 11)));
		mode32.add(new InstructionPattern("adclb" , new OperandPattern[]{RM32, IMM8}          , MODE32  , new int[]{0x83}, new ModRM(0, 12)));
		mode32.add(new InstructionPattern("sbblb" , new OperandPattern[]{RM32, IMM8}          , MODE32  , new int[]{0x83}, new ModRM(0, 13)));
		mode32.add(new InstructionPattern("andlb" , new OperandPattern[]{RM32, IMM8}          , MODE32  , new int[]{0x83}, new ModRM(0, 14)));
		mode32.add(new InstructionPattern("sublb" , new OperandPattern[]{RM32, IMM8}          , MODE32  , new int[]{0x83}, new ModRM(0, 15)));
		mode32.add(new InstructionPattern("xorlb" , new OperandPattern[]{RM32, IMM8}          , MODE32  , new int[]{0x83}, new ModRM(0, 16)));
		mode32.add(new InstructionPattern("cmplb" , new OperandPattern[]{RM32, IMM8}          , MODE32  , new int[]{0x83}, new ModRM(0, 17)));
		...
		mode32.add(new InstructionPattern("xchgw" , new OperandPattern[]{REG16}               , MODE16  , new int[]{0x90}, new RegisterInOpcode(0)));
		mode32.add(new InstructionPattern("xchgl" , new OperandPattern[]{REG32}               , MODE32  , new int[]{0x90}, new RegisterInOpcode(0)));
