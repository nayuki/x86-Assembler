...
public final class InstructionPattern {
	...
	static {
		...
		mode32.add(new InstructionPattern("notb"     , new OperandPattern[]{RM8}                 , MODELESS, new int[]{0xF6}, new ModRM(0, 12)));
		mode32.add(new InstructionPattern("negb"     , new OperandPattern[]{RM8}                 , MODELESS, new int[]{0xF6}, new ModRM(0, 13)));
		...
		mode32.add(new InstructionPattern("notw"     , new OperandPattern[]{RM16}                , MODE16  , new int[]{0xF7}, new ModRM(0, 12)));
		mode32.add(new InstructionPattern("negw"     , new OperandPattern[]{RM16}                , MODE16  , new int[]{0xF7}, new ModRM(0, 13)));
		...
		mode32.add(new InstructionPattern("notl"     , new OperandPattern[]{RM32}                , MODE32  , new int[]{0xF7}, new ModRM(0, 12)));
		mode32.add(new InstructionPattern("negl"     , new OperandPattern[]{RM32}                , MODE32  , new int[]{0xF7}, new ModRM(0, 13)));
		...
		mode32.add(new InstructionPattern("callw"    , new OperandPattern[]{RM16}                , MODE16  , new int[]{0xFF}, new ModRM(0, 12)));
		mode32.add(new InstructionPattern("lcallw"   , new OperandPattern[]{MEM}                 , MODE16  , new int[]{0xFF}, new ModRM(0, 13)));
		mode32.add(new InstructionPattern("jmpw"     , new OperandPattern[]{RM16}                , MODE16  , new int[]{0xFF}, new ModRM(0, 14)));
		mode32.add(new InstructionPattern("ljmpw"    , new OperandPattern[]{MEM}                 , MODE16  , new int[]{0xFF}, new ModRM(0, 15)));
		...
		mode32.add(new InstructionPattern("calll"    , new OperandPattern[]{RM32}                , MODE32  , new int[]{0xFF}, new ModRM(0, 12)));
		mode32.add(new InstructionPattern("lcalll"   , new OperandPattern[]{MEM}                 , MODE32  , new int[]{0xFF}, new ModRM(0, 13)));
		mode32.add(new InstructionPattern("jmpl"     , new OperandPattern[]{RM32}                , MODE32  , new int[]{0xFF}, new ModRM(0, 14)));
		mode32.add(new InstructionPattern("ljmpl"    , new OperandPattern[]{MEM}                 , MODE32  , new int[]{0xFF}, new ModRM(0, 15)));
		...
		mode32.add(new InstructionPattern("movzxwb"  , new OperandPattern[]{REG16, RM8}          , MODE16  , new int[]{0x0F, 0xB6}, new ModRM(1, 0)));
		mode32.add(new InstructionPattern("movzxlb"  , new OperandPattern[]{REG32, RM8}          , MODE32  , new int[]{0x0F, 0xB6}, new ModRM(1, 0)));
		mode32.add(new InstructionPattern("movzxww"  , new OperandPattern[]{REG16, RM16}         , MODE16  , new int[]{0x0F, 0xB7}, new ModRM(1, 0)));
		mode32.add(new InstructionPattern("movzxlw"  , new OperandPattern[]{REG32, RM16}         , MODE32  , new int[]{0x0F, 0xB7}, new ModRM(1, 0)));
		...
		mode32.add(new InstructionPattern("movsxwb"  , new OperandPattern[]{REG16, RM8}          , MODE16  , new int[]{0x0F, 0xBE}, new ModRM(1, 0)));
		mode32.add(new InstructionPattern("movsxlb"  , new OperandPattern[]{REG32, RM8}          , MODE32  , new int[]{0x0F, 0xBE}, new ModRM(1, 0)));
		mode32.add(new InstructionPattern("movsxww"  , new OperandPattern[]{REG16, RM16}         , MODE16  , new int[]{0x0F, 0xBF}, new ModRM(1, 0)));
		mode32.add(new InstructionPattern("movsxlw"  , new OperandPattern[]{REG32, RM16}         , MODE32  , new int[]{0x0F, 0xBF}, new ModRM(1, 0)));
